...
<body>
    <div class="container">
        <h1 class="text-3xl font-bold text-gray-800 mb-8 text-center">Add New Employee</h1>
        ...
        <form action="AddEmployeeServlet" method="post" class="mt-6">
            ...
            <div class="form-group">
                ...
                <input type="text" id="empName" name="empName" class="form-input" required>
            </div>
            <div class="form-group">
            ...
            <div class="form-group">
                ...
                <input type="number" step="0.01" id="bsalary" name="bsalary" class="form-input" required>
            </div>
